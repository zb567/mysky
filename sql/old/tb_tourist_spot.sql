...
VALUES
    ('长城', 'https://example.com/images/great_wall_cover.jpg',
     ...
     '["旅游", "文物保护"]',
     '中国古代伟大的防御工程，世界文化遗产。',
     1, 40.4319, 116.5704, '北京', '北京市', '中国', 4.9, '2024-04-21 12:00:00', '2024-04-21 12:00:00'),
    ('埃菲尔铁塔', 'https://example.com/images/eiffel_tower_cover.jpg',
     '{"visitors": 2000000, "revenue": 1000000}',
     '["观光", "文化交流"]',
     '法国巴黎著名地标，世界闻名的铁塔。',
     2, NULL, NULL, '巴黎', '法兰西岛大区', '法国', 4.8, '2024-04-21 12:01:00', '2024-04-21 12:01:00'),
    ('自由女神像', 'https://example.com/images/statue_of_liberty_cover.jpg',
     '{"visitors": 1500000, "revenue": 750000}',
     '["文化象征", "旅游"]',
     '美国纽约的象征，代表自由与民主的精神。',
     3, 40.6892, -74.0445, '纽约', '纽约州', '美国', 4.7, '2024-04-21 12:02:00', '2024-04-21 12:02:00');
